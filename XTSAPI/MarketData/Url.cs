...
//        {
//            return $"/apimarketdata/auth/login";
//        }
...
//        public static string OHLCHistory(ExchangeSegment exchangeSegment, long exchangeInstrumentId, DateTime startTime, DateTime endTime, int compressionValue)
//        {
//            return string.Format(CultureInfo.InvariantCulture, "instruments/ohlc?exchangeSegment={0}&exchangeInstrumentID={1}&startTime={2:MMM dd yyyy HHmmss}&endTime={3:MMM dd yyyy HHmmss}&compressionValue={4}", exchangeSegment.ToString(),exchangeInstrumentId, startTime, endTime, compressionValue);
//        }
